...
> 生成时间：2026-05-21T22:23:39.787453
> 版本：p1-baseline-v1
...
| 级别 | 类别 | 问题 | 建议 |
|------|------|------|------|
| 🟢 info | project | weekly 是 ghost 项目 | 归档或填充内容 |
...
```
主机：VM-13-249-ubuntu
运行时间：22:23:35 up 14 days,  5:24,  0 user,  load average: 0.25, 0.26, 0.33
磁盘：/dev/vda2        40G   29G  8.9G  77% /
内存：Mem:           7.5Gi       2.2Gi       2.2Gi       9.9Mi       3.5Gi       5.3Gi
Node.js：v24.15.0
...
- `69dae650-bd3c-469c-86fb-0061fb897bfe.jsonl` (175.6KB, 0h ago)
